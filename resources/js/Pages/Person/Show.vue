                                ...
                                <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                                    <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                                        <table class="min-w-full mt-4 mb-4 divide-y divide-gray-300">
                                            ...
                                            <tr v-for="(person,index) in this.persons">
                                                ...
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                    <div v-for="(institution,index) in person.institutions" class="text-gray-900">
                                                        {{institution.name.replace(/_/g," ").toUpperCase()}}
                                                    </div>
                                                </td>
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                <span v-if="person.status==='Active'" class="inline-flex rounded-full bg-green-100 px-2 text-xs font-semibold leading-5 text-green-800">
                                                    Active
                                                </span>
                                                    <span v-if="person.status!=='Active'" class="inline-flex rounded-full bg-red-100 px-2 text-xs font-semibold leading-5 text-red-800">
                                                    Not-Active
                                                </span>
                                                </td>
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
