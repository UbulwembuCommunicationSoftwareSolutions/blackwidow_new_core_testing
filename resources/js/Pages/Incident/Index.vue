                                    ...
                                    <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                                        <DataTable class="display">
                                            <div class="px-4 sm:px-6 lg:px-8">
                                                <div class="sm:flex sm:items-center">
                                                    <div class="sm:flex-auto">
                                                        <h1 class="text-xl font-semibold text-gray-900">Cases</h1>
                                                        <p class="mt-2 text-sm text-gray-700">A list of all the cases</p>
                                                    </div>
                                                    <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                                                            ...
                                                            <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                                                                <table class="min-w-full divide-y divide-gray-300">
                                                                    ...
                                                                    <tr v-for="(incident, id) in incidents" :key="incident.id" :class="id % 2 === 0 ? undefined : 'bg-gray-50'">
                                                                        ...
                                                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ incident.status_id }}</td>
