                                    ...
                                    <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                                        <table class="min-w-full mt-4 mb-4 divide-y divide-gray-300">
                                            ...
                                            <tr v-for="(incident,index) in incidents">
                                                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                                    <div class="flex items-center">
                                                        <div class="h-10 w-10 flex-shrink-0">
                                                            <img class="h-10 w-10 rounded-full" :src="'/incident_files/'+incident.profile_picture" alt="">
                                                        </div>
                                                        <div class="ml-4">
                                                            <div class="font-medium text-gray-900">{{incident.first_name}}</div>
                                                            <div class="text-gray-500">{{incident.surname}}</div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                    <div class="font-medium text-gray-900">{{incident.nationality}}</div>
                                                </td>
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                ...
                                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                                    <a v-if="$page.props.auth.permissions.includes('incident_edit')" :href="'/incident/'+incident.id+'/edit'" class="text-indigo-600 hover:text-indigo-900">
